...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="hold-transition sidebar-collapse sidebar-mini layout-fixed text-sm dark-mode" >
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" aria-label="Sidebar">
          <!-- Brand Logo -->
          <a href="/" class="brand-link">
            <img src="{{ asset('img/logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
            <span class="brand-text font-weight-light">NexusBizMaster</span>
          </a>
          ...
          <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
              <div class="image">
                <img src="{{ asset('img/logo.png') }}" class="img-circle elevation-2" alt="User">
              </div>
              <div class="info">
                <a href="#" class="d-block">Agung Trisutaji Aprian</a>
              </div>
            </div>
            <!-- Sidebar Menu -->
              <x-sidebar-menu/>
